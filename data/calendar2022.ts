...
// 05-29 is a placeholder date; currently service suspended indefinitely
data.addLongHolidayRules(
    getLocalDateFromString('2022-05-14'), getLocalDateFromString('2022-05-29'), ScheduleDays.SERVICE_SUSPENDED, null,
